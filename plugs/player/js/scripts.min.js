...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    var notes = {
        "1C": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/261-C.mp3"]
        }),
        "1Cs": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/277-C-sharp.mp3"]
        }),
        "1D": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/293-D.mp3"]
        }),
        "1Ds": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/311-D-sharp.mp3"]
        }),
        "1E": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/329-E.mp3"]
        }),
        "1F": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/349-F.mp3"]
        }),
        "1Fs": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/369F-sharp.mp3"]
        }),
        "1G": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/391-G.mp3"]
        }),
        "1Gs": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/415-G-sharp.mp3"]
        }),
        "2A": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/440-A.mp3"]
        }),
        "2As": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/466-A-sharp.mp3"]
        }),
        "2B": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/495-B.mp3"]
        }),
        "2C": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/523-C.mp3"]
        }),
        "2Cs": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/545-C-sharp.mp3"]
        }),
        "2D": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/587-D.mp3"]
        }),
        "2Ds": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/622-D-sharp.mp3"]
        }),
        "2E": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/659-E.mp3"]
        }),
        "2F": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/698-F.mp3"]
        }),
        "2Fs": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/698-F-sharp.mp3"]
        }),
        "2G": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/783-G.mp3"]
        }),
        "2Gs": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/830-G-sharp.mp3"]
        }),
        "3A": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/880-A.mp3"]
        }),
        "3As": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/932-A-sharp.mp3"]
        }),
        "3B": new Howl({
            urls: ["https://shaonianzhentan.github.io/plugs/player/midia/987-B.mp3"]
        })
    }, lockEvent = {};
